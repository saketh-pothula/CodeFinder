...
app.get("/question/:id", (req, res) => {
  ...
  /*
  creates a regular expression to find all newline characters (\n) in a string 
  and replace them with <br/> tags, which are used for line breaks in HTML. */
  var find = "\n";
